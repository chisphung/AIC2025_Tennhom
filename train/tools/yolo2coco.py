...
# # Example usage:
    # !python yolo2coco.py --images_dir "/kaggle/input/cameramatca1/fisheye_test/fisheye_test/images" --labels_dir "/kaggle/working/runs/detect/predict2/labels" --output ."/rtdetr.json" --conf 1 --submission 1 --is_fisheye8k 1